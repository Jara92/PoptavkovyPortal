...
class ResetPasswordController extends AController
{
    ...
    public function reset(Request $request, UserPasswordHasherInterface $userPasswordHasher, TranslatorInterface $translator, string $token = null): Response
    {
        if ($token) {
            ...
            return $this->redirectToRoute('app_reset_password/reset');
        }
        ...
        try {
            ...
            return $this->redirectToRoute('app_reset_password/request');
        }
    ...
    private function processSendingPasswordResetEmail(string $emailFormData, MailerInterface $mailer, TranslatorInterface $translator): RedirectResponse
    {
        ...
        if (!$user) {
            return $this->redirectToRoute('app_reset_password/check');
        }
        ...
        try {
            ...
            // the lines below and change the redirect to 'app_rest_password/request'.
